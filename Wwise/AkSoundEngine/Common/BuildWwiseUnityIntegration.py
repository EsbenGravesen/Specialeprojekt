...
class Xbox360Builder(PlatformBuilder):
	def __init__(self, platformName, arches, configs, generateSwig, CompilerKey):
		PlatformBuilder.__init__(self, platformName, arches, configs, generateSwig)
		...
		if CompilerKey in os.environ:
			...
			if CompilerKey in os.environ:
				...
				msg = 'Visual Studio 2010 or 2012 not found. Aborted.'
				self.logger.error(msg)
				raise RuntimeError(msg)
...
class PS3Builder(Xbox360Builder):
	def __init__(self, platformName, arches, configs, generateSwig):
		Xbox360Builder.__init__(self, platformName, arches, configs, generateSwig, 'VS100COMNTOOLS')
...
class WiiUBuilder(Xbox360Builder):
	def __init__(self, platformName, arches, configs, generateSwig):
		Xbox360Builder.__init__(self, platformName, arches, configs, generateSwig, 'VS100COMNTOOLS')
		self.FixedArch = 'Cafe'
...
class VitaBuilder(Xbox360Builder):
	def __init__(self, platformName, arches, configs, generateSwig):
		Xbox360Builder.__init__(self, platformName, arches, configs, generateSwig, 'VS110COMNTOOLS')
...
class WwiseUnityBuilder(object):
	...
	def CreatePlatformBuilder(self, platformName, arches, configs, generateSwig):
		...
		if platformName == 'Windows':
			...
			builder = Xbox360Builder(platformName, arches, configs, generateSwig, 'VS100COMNTOOLS')
		elif platformName == 'XBoxOne':
			builder = XboxOneBuilder(platformName, arches, configs, generateSwig)
		elif platformName == 'PS3':
			builder = PS3Builder(platformName, arches, configs, generateSwig)
			...
			builder = WiiUBuilder(platformName, arches, configs, generateSwig)
		else:
